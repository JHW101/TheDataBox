...
execute if score #this.model.anim model.i matches 0..20 run function leggy_bird:animations/leggy_bird_model_attacking/__generated__/execute/647
execute if score #this.model.anim model.i matches 21..41 run function leggy_bird:animations/leggy_bird_model_attacking/__generated__/execute/674
