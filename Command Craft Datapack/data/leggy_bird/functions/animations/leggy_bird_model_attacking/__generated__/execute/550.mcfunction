...
execute as @e[type=armor_stand,tag=model.leggy_bird.head,distance=..3.84] if score @s model.id = #this.model.id model.i at @s run function leggy_bird:animations/leggy_bird_model_attacking/__generated__/execute/551
