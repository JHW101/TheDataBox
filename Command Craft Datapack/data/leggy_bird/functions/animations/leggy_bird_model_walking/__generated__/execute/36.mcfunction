...
execute as @e[type=armor_stand,tag=model.leggy_bird.left_leg,distance=..3.84] if score @s model.id = #this.model.id model.i at @s run function leggy_bird:animations/leggy_bird_model_walking/__generated__/execute/37
