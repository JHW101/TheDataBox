...
execute store result entity @s Motion[0] double 0.1 run scoreboard players operation @s motion_y2 -= @s motion_y1
execute store result entity @s Motion[0] double 0.1 run scoreboard players operation @s motion_z2 -= @s motion_z1
